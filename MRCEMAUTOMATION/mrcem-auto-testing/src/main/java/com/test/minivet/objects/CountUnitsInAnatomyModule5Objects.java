...
public class CountUnitsInAnatomyModule5Objects extends DriverBase{
    ...
    @FindBy(xpath = "//*[text()= ' Thorax ']/parent::div/parent::div/parent::div")
    private WebElement Thorax;

    @FindBy(xpath = "//*[text()= ' Thorax ']/parent::div/H6")
    private WebElement ThoraxText;
    ...
    public CountUnitsInAnatomyModule5Objects() {
    ...
    public void checkTheToatalNoOfUnitShowingInTileIsSamesAsNoOfUnitsShowingInTHORAXModule() {
        ...
        System.out.println("total no of units showing in Thorax ----- " + Expected_count);
    ...
    public void totalUnitsInModuleIsEqualToTheTotalCountOfunitShowingInTile() {
        ...
        System.out.println(" Total units in Thorax module is equal to the total count of unit showing in Thorax tile ");
    }

    public void CheckTotalCountOfUnitsCompletedInThoraxModule() {
        try {
            Thread.sleep(5000);
        } catch (InterruptedException e) {
            throw new RuntimeException(e);
        ...
        String Expected_count = String.valueOf(row.size());
        System.out.println("total no of completed units showing in Thorax ----- " + Expected_count);
    ...
    public void totalCompletedUnitsInModuleIsEqualToTheTotalCountOfCompletedUnitShowingInTile() {
        System.out.println(" Total completed units in Thorax module is equal to the total count of completed unit showing in Thorax tile ");
