...
public class CountUnitsInMicrobiologyModule2Objects   extends DriverBase {
    ...
    @FindBy(xpath = "//*[text()= ' Specific Pathogen Groups ']/parent::div/parent::div/parent::div")
    private WebElement SpecificPathogenGroups ;

    @FindBy(xpath = "//*[text()= ' Specific Pathogen Groups ']/parent::div/h6")
    private WebElement  SpecificPathogenGroupsText;
    ...
    public CountUnitsInMicrobiologyModule2Objects() {
    ...
    public void checkTheToatalNoOfUnitShowingInTileIsSamesAsNoOfUnitsShowingInSpecificPathogenGroupsModule() {
        ...
        String s = SpecificPathogenGroupsText.getText();
        ...
        System.out.println("total no of units showing in SpecificPathogenGroups module  ----- " + Expected_count);
    ...
    public void totalUnitsInModuleIsEqualToTheTotalCountOfunitShowingInTile() {
        ...
        System.out.println(" Total units in SpecificPathogenGroups module is equal to the total count of unit showing in SpecificPathogenGroups tile ");
    }


    public void CheckTotalCountOfUnitsCompletedInSpecificPathogenGroupsModule() {
        try {
            Thread.sleep(5000);
        } catch (InterruptedException e) {
            throw new RuntimeException(e);
        ...
        String Expected_count = String.valueOf(row.size());
        System.out.println("total no of completed units showing in SpecificPathogenGroups module ----- " + Expected_count);
    ...
    public void totalCompletedUnitsInModuleIsEqualToTheTotalCountOfCompletedUnitShowingInTile() {
        System.out.println(" Total completed units in SpecificPathogenGroups module is equal to the total count of completed unit showing in SpecificPathogenGroups tile ");
