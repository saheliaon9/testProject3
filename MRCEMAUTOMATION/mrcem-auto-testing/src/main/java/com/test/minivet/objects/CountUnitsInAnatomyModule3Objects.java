...
public class CountUnitsInAnatomyModule3Objects extends DriverBase{
    ...
    @FindBy(xpath = "//*[text()= ' Head and Neck ']/parent::div/parent::div/parent::div")
    private WebElement headAndNeck;

    @FindBy(xpath = "//*[text()= ' Head and Neck ']/parent::div/H6")
    private WebElement headAndNeckText;
    ...
    public CountUnitsInAnatomyModule3Objects() {
    ...
    public void checkTheTotalNoOfUnitShowingInTileIsSamesAsNoOfUnitsShowingInHeadAndNeckModule() {
        ...
        String s = headAndNeckText.getText();
        ...
        System.out.println("total no of units showing in HEAD AND NECK ----- " + Expected_count);
    ...
    public void totalUnitsInModuleIsEqualToTheTotalCountOfunitShowingInTile() {
        ...
        System.out.println(" Total units in HEAD AND NECK module is equal to the total count of unit showing in HEAD AND NECK tile ");
    }

    public void CheckTotalCountOfUnitsCompletedInHeadAndNeckModule() {
        try {
            Thread.sleep(5000);
        } catch (InterruptedException e) {
            throw new RuntimeException(e);
        ...
        String Expected_count = String.valueOf(row.size());
        System.out.println("total no of completed units showing in headAndNeck ----- " + Expected_count);
    ...
    public void totalCompletedUnitsInModuleIsEqualToTheTotalCountOfCompletedUnitShowingInTile() {
        System.out.println(" Total completed units in headAndNeck module is equal to the total count of completed unit showing in headAndNeck tile ");
