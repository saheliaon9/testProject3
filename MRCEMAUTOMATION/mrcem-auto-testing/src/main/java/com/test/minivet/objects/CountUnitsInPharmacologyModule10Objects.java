...
public class CountUnitsInPharmacologyModule10Objects extends DriverBase {
...
@FindBy(xpath = "//*[text()= ' Respiratory Pharmacology ']/parent::div/parent::div/parent::div")
private WebElement respiratoryPharmacology;

@FindBy(xpath = "//*[text()= ' Respiratory Pharmacology ']/parent::div/h6")
private WebElement  respiratoryPharmacologyText;
...
public CountUnitsInPharmacologyModule10Objects() {
...
public void checkTheToatalNoOfUnitShowingInTileIsSamesAsNoOfUnitsShowingInRespiratoryPharmacologyModule() {
        ...
        String s = respiratoryPharmacologyText.getText();
    ...
    respiratoryPharmacology.click();
        ...
        System.out.println("total no of units showing in respiratoryPharmacology module  ----- " + Expected_count);
...
public void totalUnitsInModuleIsEqualToTheTotalCountOfunitShowingInTile() {
        ...
        System.out.println(" Total units in respiratoryPharmacology module is equal to the total count of unit showing in respiratoryPharmacology tile ");
        }


public void CheckTotalCountOfUnitsCompletedInRespiratoryPharmacologyodule() {
        try {
        Thread.sleep(5000);
        } catch (InterruptedException e) {
        throw new RuntimeException(e);
    ...
    respiratoryPharmacology.click();
        ...
        String Expected_count = String.valueOf(row.size());
        System.out.println("total no of completed units showing in respiratoryPharmacology module ----- " + Expected_count);
...
public void totalCompletedUnitsInModuleIsEqualToTheTotalCountOfCompletedUnitShowingInTile() {
        System.out.println(" Total completed units in respiratoryPharmacology module is equal to the total count of completed unit showing in respiratoryPharmacology tile ");
