...
public class CountUnitsInAnatomyModule1Objects extends DriverBase {
    ...
    @FindBy(xpath = "//*[text()= ' Abdomen and Pelvis ']/parent::div/parent::div/parent::div")
    private WebElement AbdomenAndPelvis;

    @FindBy(xpath = "//*[text()= ' Abdomen and Pelvis ']/parent::div/h6")
    private WebElement AbdomenAndPelvisText;
    ...
    public CountUnitsInAnatomyModule1Objects() {
    ...
    public void checkTheToatalNoOfUnitShowingInTileIsSamesAsNoOfUnitsShowingInAbdomenAndPelvisModule() {
        ...
        String s = AbdomenAndPelvisText.getText();
        ...
        System.out.println("total no of units showing in abdomen and pelvis ----- " + Expected_count);
    ...
    public void totalUnitsInModuleIsEqualToTheTotalCountOfunitShowingInTile() {
        ...
        System.out.println(" Total units in abdomen and pelvis module is equal to the total count of unit showing in abdomen and pelvis tile ");
    }


    public void CheckTotalCountOfUnitsCompletedInAbdomenAndPelvisModule() {
        try {
            Thread.sleep(5000);
        } catch (InterruptedException e) {
            throw new RuntimeException(e);
        ...
        String Expected_count = String.valueOf(row.size());
        System.out.println("total no of completed units showing in AbdomenAndPelvis ----- " + Expected_count);
    ...
    public void totalCompletedUnitsInModuleIsEqualToTheTotalCountOfCompletedUnitShowingInTile() {
        System.out.println(" Total completed units in AbdomenAndPelvis module is equal to the total count of completed unit showing in AbdomenAndPelvis tile ");
