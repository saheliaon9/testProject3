...
public class CountUnitsInPharmacologyModule4Objects  extends DriverBase {
    ...
    @FindBy(xpath = "//*[text()= ' Endocrine Pharmacology ']/parent::div/parent::div/parent::div")
    private WebElement endocrinePharmacology;

    @FindBy(xpath = "//*[text()= ' Endocrine Pharmacology ']/parent::div/h6")
    private WebElement endocrinepharmacologyText;
    ...
    public CountUnitsInPharmacologyModule4Objects() {
    ...
    public void checkTheToatalNoOfUnitShowingInTileIsSamesAsNoOfUnitsShowingInEndocrinePharmacologyModule() {
        ...
        String s = endocrinepharmacologyText.getText();
        ...
        System.out.println("total no of units showing in endocrinePharmacology module  ----- " + Expected_count);
    ...
    public void totalUnitsInModuleIsEqualToTheTotalCountOfunitShowingInTile() {
        ...
        System.out.println(" Total units in endocrinePharmacology module is equal to the total count of unit showing in endocrinePharmacology tile ");
    }


    public void CheckTotalCountOfUnitsCompletedInEndocrinePharmacologyModule() {
        try {
            Thread.sleep(5000);
        } catch (InterruptedException e) {
            throw new RuntimeException(e);
        ...
        String Expected_count = String.valueOf(row.size());
        System.out.println("total no of completed units showing in endocrinePharmacology module ----- " + Expected_count);
    ...
    public void totalCompletedUnitsInModuleIsEqualToTheTotalCountOfCompletedUnitShowingInTile() {
        System.out.println(" Total completed units in endocrinePharmacology module is equal to the total count of completed unit showing in endocrinePharmacology tile ");
