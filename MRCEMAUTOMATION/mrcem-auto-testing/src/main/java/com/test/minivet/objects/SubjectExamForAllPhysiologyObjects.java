...
public class SubjectExamForAllPhysiologyObjects extends DriverBase {
    ...
    @FindBy(xpath = "//*[text()='All Physiology']//parent::a")
    private WebElement allPhysiologyBtn;
    ...
    public SubjectExamForAllPhysiologyObjects()
    ...
    public void selectAllPhysiologyBtnButton() {
        wait.until(ExpectedConditions.elementToBeClickable(allPhysiologyBtn));
        allPhysiologyBtn.click();
    }
