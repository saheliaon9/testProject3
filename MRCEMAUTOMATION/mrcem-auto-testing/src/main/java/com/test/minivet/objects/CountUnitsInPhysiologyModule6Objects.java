...
public class CountUnitsInPhysiologyModule6Objects extends DriverBase {
    ...
    @FindBy(xpath = "//*[text()= ' Respiratory Physiology ']/parent::div/parent::div/parent::div")
    private WebElement RespiratoryPhysiology;

    @FindBy(xpath = "//*[text()= ' Respiratory Physiology ']/parent::div/h6")
    private WebElement RespiratoryPhysiologyText;
    ...
    public CountUnitsInPhysiologyModule6Objects() {
    ...
    public void checkTheToatalNoOfUnitShowingInTileIsSamesAsNoOfUnitsShowingInRespiratoryPhysiologyModule() {
        ...
        String s = RespiratoryPhysiologyText.getText();
        ...
        System.out.println("total no of units showing in RespiratoryPhysiology  ----- " + Expected_count);
    ...
    public void totalUnitsInModuleIsEqualToTheTotalCountOfunitShowingInTile() {
        ...
        System.out.println(" Total units in RespiratoryPhysiology module is equal to the total count of unit showing in RespiratoryPhysiology tile ");
    }


    public void CheckTotalCountOfUnitsCompletedInRespiratoryPhysiologyModule() {
        try {
            Thread.sleep(5000);
        } catch (InterruptedException e) {
            throw new RuntimeException(e);
        ...
        String Expected_count = String.valueOf(row.size());
        System.out.println("total no of completed units showing in RespiratoryPhysiology ----- " + Expected_count);
    ...
    public void totalCompletedUnitsInModuleIsEqualToTheTotalCountOfCompletedUnitShowingInTile() {
        System.out.println(" Total completed units in RespiratoryPhysiology module is equal to the total count of completed unit showing in RespiratoryPhysiology tile ");
