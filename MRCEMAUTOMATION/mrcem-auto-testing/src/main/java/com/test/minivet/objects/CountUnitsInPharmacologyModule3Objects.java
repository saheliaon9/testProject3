...
public class CountUnitsInPharmacologyModule3Objects
        extends DriverBase {
    ...
    @FindBy(xpath = "//*[text()= ' Cardiovascular Pharmacology ']/parent::div/parent::div/parent::div")
    private WebElement cardiovascularPharmacology;

    @FindBy(xpath = "//*[text()= ' Cardiovascular Pharmacology ']/parent::div/h6")
    private WebElement  cardiovascularpharmacologyText;
    ...
    public CountUnitsInPharmacologyModule3Objects() {
    ...
    public void checkTheToatalNoOfUnitShowingInTileIsSamesAsNoOfUnitsShowingIncardiovascularPharmacologyModule() {
        ...
        String s = cardiovascularpharmacologyText.getText();
        ...
        cardiovascularPharmacology.click();
        ...
        System.out.println("total no of units showing in cardiovascularPharmacology module  ----- " + Expected_count);
    ...
    public void totalUnitsInModuleIsEqualToTheTotalCountOfunitShowingInTile() {
        ...
        System.out.println(" Total units in cardiovascularPharmacology module is equal to the total count of unit showing in cardiovascularPharmacology tile ");
    }


    public void CheckTotalCountOfUnitsCompletedIncardiovascularPharmacologyModule() {
        try {
            Thread.sleep(5000);
        } catch (InterruptedException e) {
            throw new RuntimeException(e);
        ...
        String Expected_count = String.valueOf(row.size());
        System.out.println("total no of completed units showing in cardiovascularPharmacology module ----- " + Expected_count);
    ...
    public void totalCompletedUnitsInModuleIsEqualToTheTotalCountOfCompletedUnitShowingInTile() {
        System.out.println(" Total completed units in cardiovascularPharmacology module is equal to the total count of completed unit showing in cardiovascularPharmacology tile ");
