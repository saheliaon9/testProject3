...
public class CountUnitsInPharmacologyModule9Objects  extends DriverBase {
    ...
    @FindBy(xpath = "//*[text()= ' Musculoskeletal Pharmacology ']/parent::div/parent::div/parent::div")
    private WebElement Musculoskeletal;

    @FindBy(xpath = "//*[text()= ' Musculoskeletal Pharmacology ']/parent::div/h6")
    private WebElement  MusculoskeletalText;
    ...
    public CountUnitsInPharmacologyModule9Objects() {
    ...
    public void checkTheToatalNoOfUnitShowingInTileIsSamesAsNoOfUnitsShowingInMusculoskeletalPharmacologyModule() {
        ...
        String s = MusculoskeletalText.getText();
        ...
        System.out.println("total no of units showing in Musculoskeletal module  ----- " + Expected_count);
    ...
    public void totalUnitsInModuleIsEqualToTheTotalCountOfunitShowingInTile() {
        ...
        System.out.println(" Total units in Musculoskeletal module is equal to the total count of unit showing in Musculoskeletal tile ");
    }


    public void CheckTotalCountOfUnitsCompletedInMusculoskeletalPharmacologyodule() {
        try {
            Thread.sleep(5000);
        } catch (InterruptedException e) {
            throw new RuntimeException(e);
        ...
        String Expected_count = String.valueOf(row.size());
        System.out.println("total no of completed units showing in Musculoskeletal module ----- " + Expected_count);
    ...
    public void totalCompletedUnitsInModuleIsEqualToTheTotalCountOfCompletedUnitShowingInTile() {
        System.out.println(" Total completed units in Musculoskeletal module is equal to the total count of completed unit showing in Musculoskeletal tile ");
