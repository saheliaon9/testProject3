...
public class CountUnitsInAnatomyModule4Objects extends DriverBase{
    ...
    @FindBy(xpath = "//*[text()= ' Lower Limb ']/parent::div/parent::div/parent::div")
    private WebElement lowerLimb;

    @FindBy(xpath = "//*[text()= ' Lower Limb ']/parent::div/H6")
    private WebElement lowerLimbText;
    ...
    public CountUnitsInAnatomyModule4Objects() {
    ...
    public void checkTheToatalNoOfUnitShowingInTileIsSamesAsNoOfUnitsShowingInLowerLimbModule() {
        ...
        String s = lowerLimbText.getText();
        ...
        System.out.println("total no of units showing in lowerLimb ----- " + Expected_count);
    ...
    public void totalUnitsInModuleIsEqualToTheTotalCountOfunitShowingInTile() {
        ...
        System.out.println(" Total units in lowerLimb module is equal to the total count of unit showing in lowerLimb tile ");
    }

    public void CheckTotalCountOfUnitsCompletedInLowerLimbModule() {
        try {
            Thread.sleep(5000);
        } catch (InterruptedException e) {
            throw new RuntimeException(e);
        ...
        String Expected_count = String.valueOf(row.size());
        System.out.println("total no of completed units showing in lowerLimb ----- " + Expected_count);
    ...
    public void totalCompletedUnitsInModuleIsEqualToTheTotalCountOfCompletedUnitShowingInTile() {
        System.out.println(" Total completed units in lowerLimb module is equal to the total count of completed unit showing in lowerLimb tile ");
