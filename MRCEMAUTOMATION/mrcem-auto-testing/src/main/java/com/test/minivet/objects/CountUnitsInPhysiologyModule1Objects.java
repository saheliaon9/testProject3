...
public class CountUnitsInPhysiologyModule1Objects extends DriverBase {
    ...
    @FindBy(xpath = "//*[text()= ' Basic Cellular Physiology ']/parent::div/parent::div/parent::div")
    private WebElement cellularPhysiology;

    @FindBy(xpath = "//*[text()= ' Basic Cellular Physiology ']/parent::div/h6")
    private WebElement cellularPhysiologyText;
    ...
    public CountUnitsInPhysiologyModule1Objects() {
    ...
    public void checkTheToatalNoOfUnitShowingInTileIsSamesAsNoOfUnitsShowingInBasicCellularPhysiologyModule() {
        ...
        String s = cellularPhysiologyText.getText();
        ...
        System.out.println("total no of units showing in cellularPhysiology  ----- " + Expected_count);
    ...
    public void totalUnitsInModuleIsEqualToTheTotalCountOfunitShowingInTile() {
        ...
        System.out.println(" Total units in cellularPhysiology module is equal to the total count of unit showing in cellularPhysiology tile ");
    }


    public void CheckTotalCountOfUnitsCompletedInBasicCellularPhysiologyModule() {
        try {
            Thread.sleep(5000);
        } catch (InterruptedException e) {
            throw new RuntimeException(e);
        ...
        String Expected_count = String.valueOf(row.size());
        System.out.println("total no of completed units showing in cellularPhysiology ----- " + Expected_count);
    ...
    public void totalCompletedUnitsInModuleIsEqualToTheTotalCountOfCompletedUnitShowingInTile() {
        System.out.println(" Total completed units in cellularPhysiology module is equal to the total count of completed unit showing in cellularPhysiology tile ");
