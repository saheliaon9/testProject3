...
public class CountUnitsInPharmacologyModule2Objects
        extends DriverBase {
    ...
    @FindBy(xpath = "//*[text()= ' CNS Pharmacology ']/parent::div/parent::div/parent::div")
    private WebElement cnsPharmacology;

    @FindBy(xpath = "//*[text()= ' CNS Pharmacology ']/parent::div/h6")
    private WebElement  cnspharmacologyText;
    ...
    public CountUnitsInPharmacologyModule2Objects() {
    ...
    public void checkTheToatalNoOfUnitShowingInTileIsSamesAsNoOfUnitsShowingInCnsPharmacologyModule() {
        ...
        String s = cnsPharmacology.getText();
        ...
        System.out.println("total no of units showing in  cns pharmacology module  ----- " + Expected_count);
    ...
    public void totalUnitsInModuleIsEqualToTheTotalCountOfunitShowingInTile() {
        ...
        System.out.println(" Total units in cnsPharmacology module is equal to the total count of unit showing in cnsPharmacology tile ");
    }


    public void CheckTotalCountOfUnitsCompletedInCnsPharmacologyModule() {
        try {
            Thread.sleep(5000);
        } catch (InterruptedException e) {
            throw new RuntimeException(e);
        ...
        String s = cnspharmacologyText.getText();
        ...
        String Expected_count = String.valueOf(row.size());
        System.out.println("total no of completed units showing in cnsPharmacology module ----- " + Expected_count);
    ...
    public void totalCompletedUnitsInModuleIsEqualToTheTotalCountOfCompletedUnitShowingInTile() {
        System.out.println(" Total completed units in cnsPharmacology module is equal to the total count of completed unit showing in cnsPharmacology tile ");
