...
public class CountUnitsInPharmacologyModule7Objects extends DriverBase {
    ...
    @FindBy(xpath = "//*[text()= ' Immunological Products & Vaccines ']/parent::div/parent::div/parent::div")
    private WebElement ImmProductsdAndVaccine;

    @FindBy(xpath = "//*[text()= ' Immunological Products & Vaccines ']/parent::div/h6")
    private WebElement  ImmProductsdAndVaccineText;
    ...
    public CountUnitsInPharmacologyModule7Objects() {
    ...
    public void checkTheToatalNoOfUnitShowingInTileIsSamesAsNoOfUnitsShowingInImmunologicalProductsAndVaccinesModule() {
        ...
        String s = ImmProductsdAndVaccineText.getText();
        ...
        System.out.println("total no of units showing in ImmProductsdAndVaccine module  ----- " + Expected_count);
    ...
    public void totalUnitsInModuleIsEqualToTheTotalCountOfunitShowingInTile() {
        ...
        System.out.println(" Total units in ImmProductsdAndVaccine module is equal to the total count of unit showing in ImmProductsdAndVaccine tile ");
    }


    public void CheckTotalCountOfUnitsCompletedInImmunologicalProductsAndVaccinesodule() {
        try {
            Thread.sleep(5000);
        } catch (InterruptedException e) {
            throw new RuntimeException(e);
        ...
        String Expected_count = String.valueOf(row.size());
        System.out.println("total no of completed units showing in ImmProductsdAndVaccine module ----- " + Expected_count);
    ...
    public void totalCompletedUnitsInModuleIsEqualToTheTotalCountOfCompletedUnitShowingInTile() {
        System.out.println(" Total completed units in ImmProductsdAndVaccine module is equal to the total count of completed unit showing in ImmProductsdAndVaccine tile ");
