...
public class CountUnitsInMicrobiologyModule1Objects  extends DriverBase {
    ...
    @FindBy(xpath = "//*[text()= ' Microbiology ']/parent::div/parent::div/parent::div/div")
    private WebElement Microbiology;

    @FindBy(xpath = "//*[text()= ' Principles of Microbiology ']/parent::div/parent::div/parent::div")
    private WebElement PrinciplesofMicrobiology;

    @FindBy(xpath = "//*[text()= ' Principles of Microbiology ']/parent::div/h6")
    private WebElement PrinciplesofMicrobiologyText;
    ...
    public CountUnitsInMicrobiologyModule1Objects() {
    ...
    public void checkTheToatalNoOfUnitShowingInTileIsSamesAsNoOfUnitsShowingInPrinciplesOfMicrobiologyModule() {
        ...
        String s = PrinciplesofMicrobiologyText.getText();
        ...
        PrinciplesofMicrobiology.click();
        ...
        System.out.println("total no of units showing in PrinciplesofMicrobiology module  ----- " + Expected_count);
    ...
    public void totalUnitsInModuleIsEqualToTheTotalCountOfunitShowingInTile() {
        ...
        System.out.println(" Total units in PrinciplesofMicrobiology module is equal to the total count of unit showing in PrinciplesofMicrobiology tile ");
    }


    public void CheckTotalCountOfUnitsCompletedInPrinciplesOfMicrobiologyyodule() {
        try {
            Thread.sleep(5000);
        } catch (InterruptedException e) {
            throw new RuntimeException(e);
        ...
        String Expected_count = String.valueOf(row.size());
        System.out.println("total no of completed units showing in PrinciplesofMicrobiology module ----- " + Expected_count);
    ...
    public void totalCompletedUnitsInModuleIsEqualToTheTotalCountOfCompletedUnitShowingInTile() {
        System.out.println(" Total completed units in PrinciplesofMicrobiology module is equal to the total count of completed unit showing in PrinciplesofMicrobiology tile ");
