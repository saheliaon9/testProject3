...
public class CountUnitsInPhysiologyModule4Objects  extends DriverBase {
    ...
    private WebElement GastrointestinalPhysiology;

    @FindBy(xpath = "//*[text()= ' Gastrointestinal Physiology ']/parent::div/h6")
    private WebElement GastrointestinalPhysiologyText;
    ...
    public CountUnitsInPhysiologyModule4Objects() {
    ...
    public void checkTheToatalNoOfUnitShowingInTileIsSamesAsNoOfUnitsShowingInGastrointestinalPhysiologyModule() {
        ...
        String s = GastrointestinalPhysiologyText.getText();
        ...
        GastrointestinalPhysiology.click();
        ...
        System.out.println("total no of units showing in GastrointestinalPhysiology  ----- " + Expected_count);
    ...
    public void totalUnitsInModuleIsEqualToTheTotalCountOfunitShowingInTile() {
        ...
        System.out.println(" Total units in GastrointestinalPhysiology module is equal to the total count of unit showing in GastrointestinalPhysiology tile ");
    }


    public void CheckTotalCountOfUnitsCompletedInGastrointestinalPhysiologyModule() {
        try {
            Thread.sleep(5000);
        } catch (InterruptedException e) {
            throw new RuntimeException(e);
        ...
        String Expected_count = String.valueOf(row.size());
        System.out.println("total no of completed units showing in GastrointestinalPhysiology ----- " + Expected_count);
    ...
    public void totalCompletedUnitsInModuleIsEqualToTheTotalCountOfCompletedUnitShowingInTile() {
        System.out.println(" Total completed units in GastrointestinalPhysiology module is equal to the total count of completed unit showing in GastrointestinalPhysiology tile ");
