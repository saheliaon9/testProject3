...
public class SubjectExamForAllMicrobiologyObjects extends DriverBase {
    ...
    public SubjectExamForAllMicrobiologyObjects()
    ...
    public void selectAllMicrobiologyButton() {
