...
public class CountUnitsInPathologyModule2Objects  extends DriverBase {
    ...
    @FindBy(xpath = "//*[text()= ' Haematology ']/parent::div/parent::div/parent::div")
    private WebElement Haematology;

    @FindBy(xpath = "//*[text()= ' Haematology ']/parent::div/h6")
    private WebElement  HaematologyText;
    ...
    public CountUnitsInPathologyModule2Objects() {
    ...
    public void checkTheToatalNoOfUnitShowingInTileIsSamesAsNoOfUnitsShowingInHaematologyModule() {
        ...
        String s = HaematologyText.getText();
        ...
        System.out.println("total no of units showing in Haematology module  ----- " + Expected_count);
    ...
    public void totalUnitsInModuleIsEqualToTheTotalCountOfunitShowingInTile() {
        ...
        System.out.println(" Total units in Haematology module is equal to the total count of unit showing in Haematology tile ");
    }


    public void CheckTotalCountOfUnitsCompletedInHaematologyModule() {
        try {
            Thread.sleep(5000);
        } catch (InterruptedException e) {
            throw new RuntimeException(e);
        ...
        String Expected_count = String.valueOf(row.size());
        System.out.println("total no of completed units showing in Haematology module ----- " + Expected_count);
    ...
    public void totalCompletedUnitsInModuleIsEqualToTheTotalCountOfCompletedUnitShowingInTile() {
        System.out.println(" Total completed units in Haematology module is equal to the total count of completed unit showing in Haematology tile ");
