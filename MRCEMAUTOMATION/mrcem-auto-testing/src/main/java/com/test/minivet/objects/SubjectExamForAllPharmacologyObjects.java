...
public class SubjectExamForAllPharmacologyObjects  extends DriverBase {
    ...
    @FindBy(xpath = "//*[text()='All Pharmacology']//parent::a")
    private WebElement allPharmacologyBtn;
    ...
    public SubjectExamForAllPharmacologyObjects()
    ...
    public void selectAllPharmacologyButton() {
        wait.until(ExpectedConditions.elementToBeClickable(allPharmacologyBtn));
        allPharmacologyBtn.click();
    }
    ...
    public void continueExamAndDashboardBtnIsDisplayed () {
        ...
        Assert.assertTrue(continueExam.isDisplayed() && goTodashboardBtn.isDisplayed());
