...
public class CountUnitsInPhysiologyModule2Objects  extends DriverBase {
    ...
    @FindBy(xpath = "//*[text()= ' Cardiovascular Physiology ']/parent::div/parent::div/parent::div")
    private WebElement cardiovascular;

    @FindBy(xpath = "//*[text()= ' Cardiovascular Physiology ']/parent::div/h6")
    private WebElement cardiovascularText;
    ...
    public CountUnitsInPhysiologyModule2Objects() {
    ...
    public void checkTheToatalNoOfUnitShowingInTileIsSamesAsNoOfUnitsShowingInCardiovascularModule() {
        ...
        String s = cardiovascularText.getText();
        ...
        System.out.println("total no of units showing in cardiovascular  ----- " + Expected_count);
    ...
    public void totalUnitsInModuleIsEqualToTheTotalCountOfunitShowingInTile() {
        ...
        System.out.println(" Total units in cardiovascular module is equal to the total count of unit showing in cardiovascular tile ");
    }


    public void CheckTotalCountOfUnitsCompletedInCardiovascularModule() {
        try {
            Thread.sleep(5000);
        } catch (InterruptedException e) {
            throw new RuntimeException(e);
        ...
        String Expected_count = String.valueOf(row.size());
        System.out.println("total no of completed units showing in cardiovascular ----- " + Expected_count);
    ...
    public void totalCompletedUnitsInModuleIsEqualToTheTotalCountOfCompletedUnitShowingInTile() {
        System.out.println(" Total completed units in cardiovascular module is equal to the total count of completed unit showing in cardiovascular tile ");
