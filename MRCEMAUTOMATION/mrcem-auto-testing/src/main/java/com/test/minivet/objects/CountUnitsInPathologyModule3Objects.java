...
public class CountUnitsInPathologyModule3Objects  extends DriverBase {
    ...
    @FindBy(xpath = "//*[text()= ' Pathology of Infections ']/parent::div/parent::div/parent::div")
    private WebElement pathologyOfInfection;

    @FindBy(xpath = "//*[text()= ' Pathology of Infections ']/parent::div/h6")
    private WebElement  pathologyOfInfectionText;
    ...
    public CountUnitsInPathologyModule3Objects() {
    ...
    public void checkTheToatalNoOfUnitShowingInTileIsSamesAsNoOfUnitsShowingInPathologyOfInfectionsModule() {
        ...
        String s = pathologyOfInfectionText.getText();
        ...
        System.out.println("total no of units showing in pathologyOfInfection module  ----- " + Expected_count);
    ...
    public void totalUnitsInModuleIsEqualToTheTotalCountOfunitShowingInTile() {
        ...
        System.out.println(" Total units in pathologyOfInfection module is equal to the total count of unit showing in pathologyOfInfection tile ");
    }


    public void CheckTotalCountOfUnitsCompletedInPathologyOfInfectionodule() {
        try {
            Thread.sleep(5000);
        } catch (InterruptedException e) {
            throw new RuntimeException(e);
