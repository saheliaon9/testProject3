...
public class SubjectExamForAllPathologyObjects extends DriverBase {
    ...
    @FindBy(xpath = "//*[text()='All Pathology']//parent::a")
    private WebElement allPathologyBtn;
    ...
    public SubjectExamForAllPathologyObjects()
    ...
    public void selectAllPathologyButton() {
        wait.until(ExpectedConditions.elementToBeClickable(allPathologyBtn));
        allPathologyBtn.click();
    }
