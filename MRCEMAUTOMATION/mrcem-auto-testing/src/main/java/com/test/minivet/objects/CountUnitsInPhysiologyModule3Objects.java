...
public class CountUnitsInPhysiologyModule3Objects extends DriverBase {
    ...
    @FindBy(xpath = "//*[text()= ' Endocrine Physiology ']/parent::div/parent::div/parent::div")
    private WebElement EndocrinePhysiology;

    @FindBy(xpath = "//*[text()= ' Endocrine Physiology ']/parent::div/h6")
    private WebElement EndocrinePhysiologyText;
    ...
    public CountUnitsInPhysiologyModule3Objects() {
    ...
    public void checkTheToatalNoOfUnitShowingInTileIsSamesAsNoOfUnitsShowingInEndocrinePhysiologyModule() {
        ...
        String s = EndocrinePhysiologyText.getText();
        ...
        System.out.println("total no of units showing in EndocrinePhysiology  ----- " + Expected_count);
    ...
    public void totalUnitsInModuleIsEqualToTheTotalCountOfunitShowingInTile() {
        ...
        System.out.println(" Total units in EndocrinePhysiology module is equal to the total count of unit showing in EndocrinePhysiology tile ");
    }


    public void CheckTotalCountOfUnitsCompletedInEndocrinePhysiologyModule() {
        try {
            Thread.sleep(5000);
        } catch (InterruptedException e) {
            throw new RuntimeException(e);
        ...
        String Expected_count = String.valueOf(row.size());
        System.out.println("total no of completed units showing in EndocrinePhysiology ----- " + Expected_count);
    ...
    public void totalCompletedUnitsInModuleIsEqualToTheTotalCountOfCompletedUnitShowingInTile() {
        System.out.println(" Total completed units in EndocrinePhysiology module is equal to the total count of completed unit showing in EndocrinePhysiology tile ");
