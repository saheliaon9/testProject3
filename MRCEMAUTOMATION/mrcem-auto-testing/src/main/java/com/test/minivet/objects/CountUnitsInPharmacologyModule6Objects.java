...
public class CountUnitsInPharmacologyModule6Objects extends DriverBase {
    ...
    @FindBy(xpath = "//*[text()= ' Gastrointestinal Pharmacology ']/parent::div/parent::div/parent::div")
    private WebElement GastrointestinalPharmacology;

    @FindBy(xpath = "//*[text()= ' Gastrointestinal Pharmacology ']/parent::div/h6")
    private WebElement GastrointestinalPharmacologyText;
    ...
    public CountUnitsInPharmacologyModule6Objects() {
    ...
    public void checkTheTotalNoOfUnitShowingInTileIsSamesAsNoOfUnitsShowingIngGastrointestinalPharmacologyModule() {
        ...
        String s = GastrointestinalPharmacologyText.getText();
        ...
        GastrointestinalPharmacology.click();
        ...
        System.out.println("total no of units showing in GastrointestinalPharmacology module  ----- " + Expected_count);
    ...
    public void totalUnitsInModuleIsEqualToTheTotalCountOfunitShowingInTile() {
        ...
        System.out.println(" Total units in GastrointestinalPharmacology module is equal to the total count of unit showing in GastrointestinalPharmacology tile ");
    }


    public void CheckTotalCountOfUnitsCompletedInGastrointestinalPharmacologyModule() {
        try {
            Thread.sleep(5000);
        } catch (InterruptedException e) {
            throw new RuntimeException(e);
        ...
        String Expected_count = String.valueOf(row.size());
        System.out.println("total no of completed units showing in GastrointestinalPharmacology module ----- " + Expected_count);
    ...
    public void totalCompletedUnitsInModuleIsEqualToTheTotalCountOfCompletedUnitShowingInTile() {
        System.out.println(" Total completed units in GastrointestinalPharmacology module is equal to the total count of completed unit showing in GastrointestinalPharmacology tile ");
